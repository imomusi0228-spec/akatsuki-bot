...
async function processVCReport(guild, settings) {
    ...
    const footerText = settings.branding_footer_text || "Akatsuki Engagement Report";
...
温かいお声掛けが、再会のきっかけになるかもしれません。`;
            ...
            const footerText = settings.branding_footer_text || "Akatsuki Community Health Radar";
