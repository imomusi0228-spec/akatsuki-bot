    ...
    .addSubcommand(sub =>
        sub.setName("setup")
            ...
            .addChannelOption(opt => opt
                .setName("channel")
                .setNameLocalizations({ ja: "チャンネル", "en-US": "channel", "en-GB": "channel" })
            ...
            .addStringOption(opt => opt
                .setName("description")
                .setNameLocalizations({ ja: "説明", "en-US": "description", "en-GB": "description" })
...
export async function execute(interaction) {
    ...
    if (sub === "setup") {
        ...
        const title = interaction.options.getString("title") || (locale === "ja" ? "🎫 サポートチケット" : "🎫 Support Ticket");
        const description = interaction.options.getString("description") || (locale === "ja"
        ...
        await interaction.reply({
            content: locale === "ja" ? `✅ パネルを <#${targetChannel.id}> に設置しました。` : `✅ Panel deployed to <#${targetChannel.id}>.`,
            ephemeral: true
        });
    }
}
