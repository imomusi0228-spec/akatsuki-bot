    ...
    <body>
      <div class="guide-container">
        <div class="hero">
          ...
          <p class="muted" style="text-align:center;">サーバー管理をよりスマートに、より安全に。<br>コミュニティの健全な運営をサポートする多機能ボットです。</p>
        </div>
        ...
        <div id="section-free" class="tier-section active">
          <div style="text-align:center; margin-bottom:32px;" class="muted">
            <p>基本的な保護機能と可視化機能を利用できます。<br>安全なコミュニティ構築の第一歩としてご活用ください。</p>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">/ngword <span class="cmd-badge">基本防衛</span></div>
            <p>不適切な言葉を自動的に検出し、削除します。正規表現を用いた柔軟なパターン設定も可能です。</p>
            <div class="use-case">
              <strong>💡 活用例：健全なコミュニティ維持</strong><br>
                暴言や不適切なリンクなどを自動的に排除し、モデレーターの負担を軽減します。
            </div>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">/vc <span class="cmd-badge">活動記録</span></div>
            <p>ボイスチャンネルの利用状況を集計します。メンバーのアクティビティを把握するのに役立ちます。</p>
            <div class="use-case">
              <strong>💡 活用例：活動状況の可視化</strong><br>
                どの時間帯にコミュニティが活発か、誰が中心となって交流しているかを把握できます。
            </div>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">/setlog <span class="cmd-badge">記録保管</span></div>
            <p>NGワードの検知ログや入退室ログの送信先チャンネルを設定できます。</p>
          </div>
        </div>
        ...
        <div id="section-pro" class="tier-section">
          <div style="text-align:center; margin-bottom:32px;" class="muted">
            <p>Web管理画面へのアクセスが解放されます。<br>より詳細な設定と効率的な管理が可能になります。</p>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">/activity <span class="cmd-badge">メンバー管理</span></div>
            <p>長期間活動のないメンバーをリストアップします。判定基準はWeb管理画面から設定可能です。</p>
            <div class="use-case">
              <strong>💡 活用例：定期的な名簿整理</strong><br>
                アクティブなメンバーに限定したコミュニティ運営を行う際の、整理の判断材料として活用できます。
            </div>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">Web管理画面 <span class="cmd-badge">集中管理</span></div>
            <p>ブラウザからNGワードの管理やサーバー設定、アクティビティの確認が可能です。</p>
          </div>
        </div>
        ...
        <div id="section-pro_plus" class="tier-section">
          <div style="text-align:center; margin-bottom:32px;" class="muted">
            <p>高度な分析機能とデータエクスポート機能を提供します。<br>大規模なコミュニティ運営に最適なツールです。</p>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">/scan <span class="cmd-badge">過去ログ調査</span></div>
            <p>過去のメッセージログを遡り、新しいルールに抵触する投稿がないかを確認できます。</p>
          </div>

          <div class="cmd-card">
            <div class="cmd-name">詳細分析・データ抽出 <span class="cmd-badge">Web機能</span></div>
            <p>参加日やロール、自己紹介の有無などによる詳細なメンバー抽出と、CSV形式でのダウンロードが可能です。</p>
          </div>
        </div>

        <footer style="text-align: center; padding-top: 40px; border-top: 1px solid var(--border-color); margin-top:60px;" class="muted">
          <p>&copy; 2026 Akatsuki Bot - スマートなサーバー運営のために。</p>
        </footer>
      </div>
