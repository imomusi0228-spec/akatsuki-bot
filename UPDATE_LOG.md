...
## ✨ ウェブダッシュボードの機能拡全
- **プラン比較の精密化**: `features` ページの比較表を最新の機能（CSVエクスポート、Anti-Raidなど）に合わせて更新。
- **UIコンポーネントの調整**: ダッシュボードおよび管理画面のレイアウトを改善し、情報の視認性を向上。
- **デプロイ・パイプラインの整備**: GitHub Actions 経由でのデプロイを安定化させるためのビルドスクリプトを導入。
