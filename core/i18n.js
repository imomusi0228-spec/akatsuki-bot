export const DICTIONARY = {
    ja: {
        ...
        feature_antiraid: "アンチ・レイド（大量参加検知）",
        feature_intro_gate: "自動自己紹介ゲート",
        limit_10: "5個",
        limit_50: "20個",
        limit_100: "50個",
        limit_5: "5個",
        ...
        ng_log_channel: "NGログ保存先",
        ng_log_channel_desc: "NG検知・管理ログの保存先を指定します（指定しない場合は「通知・ログ送信用チャンネル」に送信されます）。",
        config_general: "基本構成",
    ...
    en: {
        ...
        feature_vclog: "VC Join/Leave Logs",
        ...
        feature_antiraid: "Anti-Raid (Mass Join Detection)",
        feature_intro_gate: "Auto Self-Introduction Gate",
        limit_10: "5 Words",
        limit_50: "20 Words",
        limit_100: "50 Words",
        limit_5: "5 Words",
        ...
        ng_log_channel: "NG Log Channel",
        ng_log_channel_desc: "Channel for NG detection logs (If unconnected, uses Log Channel above)",
        save: "Save",
